...
# Get the directory where the script is located (embedding_service)
...
Write-Host "Starting copy process for embedding_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for embedding_service." -ForegroundColor Green
