...
# Get the directory where the script is located (core_service)
...
Write-Host "Starting copy process for core_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for core_service." -ForegroundColor Green
