...
def download_wheels():
    ...
    print("3. All Python dependencies are provided as pre-compiled wheel files")
    print("4. No gcc or build tools are required in the airgapped environment")
    print("\nTo use these packages in an airgapped environment:")
    print("1. Copy the entire direct_chat_service directory to the target machine")
    print("2. Build the Docker image using: docker build -t direct_chat_service .")
    print("3. Run the container using: docker run -p 8011:8011 -v ./data:/app/data -v ./sessions:/app/sessions direct_chat_service")
