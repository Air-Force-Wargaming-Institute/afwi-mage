...
# Service: direct_chat_service

# Get the directory where the script is located (direct_chat_service)
...
Write-Host "Starting copy process for direct_chat_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for direct_chat_service." -ForegroundColor Green
