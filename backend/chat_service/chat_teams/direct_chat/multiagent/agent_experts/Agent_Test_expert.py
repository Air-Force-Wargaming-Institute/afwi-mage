...
AGENT_FILE_NAME = "Agent_Test"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """Agent Test Selection"""
AGENT_INSTRUCTIONS = """Do what the user wants"""
LLM_MODEL = "gpt-3.5-turbo"
COLOR = "#FF0000"
CREATED_AT = "2025-01-29T20:33:09.514371"
MODIFIED_AT = "2025-01-29T22:57:58.593996"
...
def Agent_Test_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if bool(config["SOLO_AGENT"]):
        prompt = PromptTemplate(
            ...
            template="You are the Agent Test expert. Here is your job description: Do what the user wants. You have been asked this question: {question}. Please provide a detailed and comprehensive answer to the question, to the best of your abilities."
        )
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---Agent Test AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: Agent Test is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def Agent_Test_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---Agent Test COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "Agent_Test"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def Agent_Test_requester(state: GraphState) -> GraphState:
    ...
    if agent_reflection:
        if shared_state.COLLAB_LOOP:
            ...
            request = f"Here is the feedback from the Agent Test expert in regards to the analysis generated from the document summery: {agent_reflection}.\n\nPlease consider the expert feedback and retrieve documents that are most related to the question: {question}.\nProvide a summary without embellishment or personal interpertation. Also provide sources or references when possible."

            print(request)

            return {"keys": {**state_dict, "last_actor": whoami, whoami+"_request": request, whoami+"_reflected": True}}
    else:
        request = f"I am the Agent Test expert in a collaborative panel of multi-discipline subject matter experts. This is my role in the panel: Do what the user wants. Please retrieve documents that are most related to this question: {question}. Please retrieve documents that are most related to the question and provide a summary without embellishment or personal interpertation. Also provide sources or references when possible."
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "Agent Test"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "Agent_Test"                     #PRC_Domestic_Stability.py
...
COLOR = "#FF0000"                                         #FF0000
CREATED_AT = "2025-01-29T20:33:09.514371"                               #2024-12-15
MODIFIED_AT = "2025-01-29T22:57:58.593996"                             #2025-01-23