...
def technology_innovation_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    """
    The PRC Technology and Innovation Expert
    ...
    if reflected:
        print("\n\n\t---------------------------\n\n\t---TECHNOLOGY AND INNOVATION EXPERT AFTER REFLECTION---\n\n\t---------------------------\n\n\t")
        ...
        if collaborator:
            ...
            prompt = PromptTemplate(
                ...
                template="You are the PRC Technology and Innovation Expert in a multi-agent system. You just wrote the following report:\n{old_analysis}\n\nHere is the feedback to your report:\n{critique}\n\nYou also collaborated with others, and they provided this augmentation to your report:\n{collab_report}\n\nPlease consider the expert feedback and collaboration and revise your report to answer this question:\n{question}\n\nDo not simply rewrite your previous report. Instead, incorporate the feedback and revise your report to answer the question. Concentrate on the PRC's advancements in key technologies. Your analysis should: 1. Explain how technological factors relate to the issue in the query. 2. Provide details on relevant advancements in AI, quantum computing, biotechnology, etc. 3. Assess potential military and economic applications of these technologies. 4. Discuss any recent technological breakthroughs or initiatives that impact the issue. Use specific examples from the documents of China's technological developments and their implications.\n\nDocument Summary: {document_summary}\n\nRelevant Documents: {relevant_docs}\n\nAnalysis:"
            )
        ...
        prompt = PromptTemplate(
            ...
            template="You are the Technology and Innovation Expert in a multi-agent system. Monitor the PRC's advancements in key technologies. Your task is to use the moderator guidance and provided documents to answer the question. Your analysis should: 1. Explain how technological factors relate to the issue in the query. 2. Provide details on relevant advancements in AI, quantum computing, biotechnology, etc. 3. Assess potential military and economic applications of these technologies. 4. Discuss any recent technological breakthroughs or initiatives that impact the issue. Use specific examples from the documents of China's technological developments and their implications.\n\nModerator Guidance: {moderator_guidance}\n\nQuestion: {question}\n\nDocument Summary: {document_summary}\n\nRelevant Documents: {relevant_docs}\n\nAnalysis:"
        )
        ...
        reflection_prompt = PromptTemplate(
            ...
            template="You are a professional analyst who specializes in reviewing and critiquing reports on PRC technology and innovation, specifically the PRC's advancements in key technologies. You are tasked to provide a critical analysis on a report about the PRC's technology and innovation and provide feedback and identify potential mischaracterizations in the analysis along with calling out information that is not true or that you suspect may be innaccurate. After explaining your findings of the initial report, create a succinct list of instructions for the expert to incorporate as corrections or clarifications in the expert's new draft of their report. The report is as follows: {analysis}.\n\nSupport your points with relevant facts and examples found in the this document summary: {documents_text}.\n\nCritique:"
        )
...
def technology_innovation_requester(state: GraphState) -> GraphState:
    """
    The PRC Technology and Innovation Requester
    Logically, it is part of the technology_innovation_expert, but for the sake of functionality, it is separate.
    ...
    It will either request documents that are most relevant to the question, or it will request documents that are most relevant to the feedback from the PRC Technology and Innovation Expert.
