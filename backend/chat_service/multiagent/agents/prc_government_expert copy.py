...
def expert_subgraph_report(state: ExpertState):
    ...
    old_analysis = state[whoami+"_analysis"]
    critique = state[whoami+"_reflection"]
    collaborator = state.get("collaborator")
...
def collab_subgraph_entry(state: ExpertState):
    banner = "\n\n\t---------------------------\n\n\t---prc government REQUESTER---\n\n\t---------------------------\n\n\t"
    ...
    question = state["question"]
    agent_reflection = state[my_expert+"_reflection"]
    my_expert_analysis = state[my_expert+"_analysis"]
    collab_areas = state[my_expert+"_collab_areas"]
    #Librarian request
    ...
    return { my_expert+"_"+whoami+"_collab_report": collab_report}
