...
# Get the directory where the script is located (extraction_service)
...
Write-Host "Starting copy process for extraction_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for extraction_service." -ForegroundColor Green
