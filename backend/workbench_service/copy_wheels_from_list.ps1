...
# Get the directory where the script is located (workbench_service)
...
Write-Host "Starting copy process for workbench_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for workbench_service." -ForegroundColor Green
