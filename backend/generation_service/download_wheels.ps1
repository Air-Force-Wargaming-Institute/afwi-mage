# PowerShell script to download Linux-compatible Python wheels for generation_service
...
$ServiceName = "generation_service"
...
if ($doZip) {
    ...
    try {
        ...
        # Push-Location $scriptDirAbsolute # This was causing an imbalance with Pop-Location if an error occurred before Compress-Archive
    ...
    } # Removed finally Pop-Location as Push-Location was removed/conditional
}
