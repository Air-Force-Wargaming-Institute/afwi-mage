...
# Get the directory where the script is located (generation_service)
...
Write-Host "Starting copy process for generation_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for generation_service." -ForegroundColor Green
