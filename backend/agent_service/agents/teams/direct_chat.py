...
AGENT_ZERO = "direct_agent_1"       #default is null_0
AGENT_ONE = "null_1"         #default is null_1
...
AGENT_FILE_NAMES = ['direct_agent_1']
AGENT_FILE_INSTRUCTIONS = ["You are an AI assistant that does your best to help answer any question or query that the user has."]
...
if AGENT_ZERO != "null_0":
    from multiagent.agent_experts.direct_agent_1_expert import direct_agent_1_expert, direct_agent_1_requester, direct_agent_1_collaborator
# if AGENT_ONE != "null_1":
#     from multiagent.agent_experts.null_1_expert import null_1_expert, null_1_requester, null_1_collaborator
# if AGENT_TWO != "null_2":
...
def direct_chat_graph() -> StateGraph:
    """
    ...
    #--------------------Expert Agents--------------------
    if AGENT_ZERO != "null_0":
        workflow.add_node("direct_agent_1", functools.partial(direct_agent_1_expert, llm=streaming_llm))
    # if AGENT_ONE != "null_1":
    #     workflow.add_node("null_1", functools.partial(null_1_expert, llm=streaming_llm))
    # if AGENT_TWO != "null_2":
    ...
    #--------------------Requesters--------------------
    # if AGENT_ZERO != "null_0":
    #     workflow.add_node("direct_agent_1_requester", direct_agent_1_requester)
    # if AGENT_ONE != "null_1":
    #     workflow.add_node("null_1_requester", null_1_requester)
    # if AGENT_TWO != "null_2":
    ...
    #--------------------Collaborators--------------------
    # if AGENT_ZERO != "null_0":
    #     workflow.add_node("direct_agent_1_collaborator", functools.partial(direct_agent_1_collaborator, llm=streaming_llm))
    # if AGENT_ONE != "null_1":
    #     workflow.add_node("null_1_collaborator", functools.partial(null_1_collaborator, llm=streaming_llm))
    # if AGENT_TWO != "null_2":
