...
def US_Economics_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---US Economics AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        # print("\tINFO: US Economics is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def US_Economics_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Economics COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Economics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def US_Economics_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Economics REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Economics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "US Economics"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "US_Economics"                     #PRC_Domestic_Stability.py
...
MODIFIED_AT = "2025-02-06T17:12:19.415826"                             #2025-01-23