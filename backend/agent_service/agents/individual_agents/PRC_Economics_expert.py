...
def PRC_Economics_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---PRC Economics AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        # print("\tINFO: PRC Economics is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def PRC_Economics_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---PRC Economics COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "PRC_Economics"
    state_dict = state["keys"]
    question = state_dict["question"]
    ...
    prompt = PromptTemplate(
        ...
        template="You are the PRC Economics expert in a in a collaborative panel of multi-discipline subject matter experts. Here is your job description: You are the PRC Economic Expert in a multi-agent system. Focus on the PRCs economic policies, trade relationships, and industrial strategies. \n\nYour analysis should \n1. Predict economic actions and their geopolitical implications relevant to the query. \n2. Explain how economic factors influence PRCs approach to the issue at hand.\n3. Provide data on relevant economic indicators, trade patterns, or industrial policies.\n4. Discuss any recent economic initiatives or shifts that relate to the user\'s question. Use specific economic data and examples from the documents to support your points. Your task is to use the moderator guidance and provided documents to answer the question.. Your task is to review the report and add to, or rewrite, the areas of the report you were asked to assist with, in order to strengthen the report. You also have access to a set of documents to help you with your task.\n\nReport: {last_actor_analysis}\n\nAreas of the report to improve: {collab_areas}\n\nAnalysis:"
    )
...
def PRC_Economics_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---PRC Economics REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "PRC_Economics"
    state_dict = state["keys"]
    question = state_dict["question"]
    ...
    if agent_reflection:
        if shared_state.COLLAB_LOOP:
            ...
            request = f"Here is the feedback from the PRC Economics expert in regards to the analysis generated from the document summery: {agent_reflection}.\n\nPlease consider the expert feedback and retrieve documents that are most related to the question: {question}.\nProvide a summary without embellishment or personal interpertation. Also provide sources or references when possible."

            print(request)

            return {"keys": {**state_dict, "last_actor": whoami, whoami+"_request": request, whoami+"_reflected": True}}
    else:
        request = f"I am the PRC Economics expert in a collaborative panel of multi-discipline subject matter experts. This is my role in the panel: You are the PRC Economic Expert in a multi-agent system. Focus on the PRCs economic policies, trade relationships, and industrial strategies. \n\nYour analysis should \n1. Predict economic actions and their geopolitical implications relevant to the query. \n2. Explain how economic factors influence PRCs approach to the issue at hand.\n3. Provide data on relevant economic indicators, trade patterns, or industrial policies.\n4. Discuss any recent economic initiatives or shifts that relate to the user\'s question. Use specific economic data and examples from the documents to support your points. Your task is to use the moderator guidance and provided documents to answer the question.. Please retrieve documents that are most related to this question: {question}. Please retrieve documents that are most related to the question and provide a summary without embellishment or personal interpertation. Also provide sources or references when possible."
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "PRC Economics"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "PRC_Economics"                     #PRC_Domestic_Stability.py
...
COLOR = "#FF0000"                                         #FF0000
CREATED_AT = "2025-02-03T21:50:09.886812"                               #2024-12-15
MODIFIED_AT = "2025-02-07T20:21:18.407088"                             #2025-01-23