...
def US_Technology_and_Innovation_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    state_dict = state["keys"]
    question = state_dict["question"]
    whoami = "US_Technology_and_Innovation"
    config = load_config()
    if bool(config["SOLO_AGENT"]):
        prompt = PromptTemplate(
            input_variables=["question"],
            template="You are the US Technology and Innovation expert. Here is your job description: You are the Technology and Innovation Expert in a multi-agent system. Monitor the United States\' advancements in key technologies.\n\nYour task is to use the moderator guidance and provided documents to answer the question.\n\nYour analysis should\n1. Explain how technological factors relate to the issue in the query.\n2. Provide details on relevant advancements in AI, quantum computing, biotechnology, etc.\n3. Assess potential military and economic applications of these technologies.\n4. Discuss any recent technological breakthroughs or initiatives that impact the issue. Use specific examples from the documents of the US\'s technological developments and their implications.. You have been asked this question: {question}. Please provide a detailed and comprehensive answer to the question, to the best of your abilities."
        )
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---US Technology and Innovation AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        # print("\tINFO: US Technology and Innovation is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def US_Technology_and_Innovation_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Technology and Innovation COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Technology_and_Innovation"
    state_dict = state["keys"]
    question = state_dict["question"]
    ...
    prompt = PromptTemplate(
        ...
        template="You are the US Technology and Innovation expert in a in a collaborative panel of multi-discipline subject matter experts. Here is your job description: You are the Technology and Innovation Expert in a multi-agent system. Monitor the United States\' advancements in key technologies.\n\nYour task is to use the moderator guidance and provided documents to answer the question.\n\nYour analysis should\n1. Explain how technological factors relate to the issue in the query.\n2. Provide details on relevant advancements in AI, quantum computing, biotechnology, etc.\n3. Assess potential military and economic applications of these technologies.\n4. Discuss any recent technological breakthroughs or initiatives that impact the issue. Use specific examples from the documents of the US\'s technological developments and their implications.. Your task is to review the report and add to, or rewrite, the areas of the report you were asked to assist with, in order to strengthen the report. You also have access to a set of documents to help you with your task.\n\nReport: {last_actor_analysis}\n\nAreas of the report to improve: {collab_areas}\n\nAnalysis:"
    )
...
def US_Technology_and_Innovation_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Technology and Innovation REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Technology_and_Innovation"
    state_dict = state["keys"]
    question = state_dict["question"]
    ...
    if agent_reflection:
        if shared_state.COLLAB_LOOP:
            ...
            request = f"Here is the feedback from the US Technology and Innovation expert in regards to the analysis generated from the document summery: {agent_reflection}.\n\nPlease consider the expert feedback and retrieve documents that are most related to the question: {question}.\nProvide a summary without embellishment or personal interpertation. Also provide sources or references when possible."

            print(request)

            return {"keys": {**state_dict, "last_actor": whoami, whoami+"_request": request, whoami+"_reflected": True}}
    else:
        request = f"I am the US Technology and Innovation expert in a collaborative panel of multi-discipline subject matter experts. This is my role in the panel: You are the Technology and Innovation Expert in a multi-agent system. Monitor the United States\' advancements in key technologies.\n\nYour task is to use the moderator guidance and provided documents to answer the question.\n\nYour analysis should\n1. Explain how technological factors relate to the issue in the query.\n2. Provide details on relevant advancements in AI, quantum computing, biotechnology, etc.\n3. Assess potential military and economic applications of these technologies.\n4. Discuss any recent technological breakthroughs or initiatives that impact the issue. Use specific examples from the documents of the US\'s technological developments and their implications.. Please retrieve documents that are most related to this question: {question}. Please retrieve documents that are most related to the question and provide a summary without embellishment or personal interpertation. Also provide sources or references when possible."
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "US Technology and Innovation"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "US_Technology_and_Innovation"                     #PRC_Domestic_Stability.py
...
COLOR = "#0000FF"                                         #FF0000
CREATED_AT = "2025-02-04T15:41:55.121977"                               #2024-12-15
MODIFIED_AT = "2025-02-07T20:21:37.368638"                             #2025-01-23