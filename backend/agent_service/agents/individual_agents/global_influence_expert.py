...
AGENT_NAME = "global influence"
AGENT_FILE_NAME = "global_influence"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """PRC Global Influence"""
...
COLOR = "#FFA500"
CREATED_AT = "2025-01-17T17:13:11.465193"
MODIFIED_AT = "2025-01-29T21:24:05.169467"
...
def global_influence_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if bool(config["SOLO_AGENT"]):
        prompt = PromptTemplate(
            ...
            template="You are the global influence expert. Here is your job description: You are the Global Influence Expert in a multi-agent system. Track the PRC\'s efforts to expand its global influence. Your task is to use the moderator guidance and provided documents to answer the question. \n\nYour analysis should \n1. Assess the impact of PRC\'s global initiatives on the issue in the query. \n2. Discuss relevant diplomatic efforts, investments, or soft power initiatives. \n3. Analyze how PRC\'s actions affect international institutions and norms. \n4. Identify any global trends or reactions that influence PRC\'s approach. Use concrete examples from the documents of PRC\'s global activities and their outcomes.. You have been asked this question: {question}. Please provide a detailed and comprehensive answer to the question, to the best of your abilities."
        )
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---global influence AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: global influence is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def global_influence_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    prompt = PromptTemplate(
        ...
        template="You are the global influence expert in a in a collaborative panel of multi-discipline subject matter experts. Here is your job description: You are the Global Influence Expert in a multi-agent system. Track the PRC\'s efforts to expand its global influence. Your task is to use the moderator guidance and provided documents to answer the question. \n\nYour analysis should \n1. Assess the impact of PRC\'s global initiatives on the issue in the query. \n2. Discuss relevant diplomatic efforts, investments, or soft power initiatives. \n3. Analyze how PRC\'s actions affect international institutions and norms. \n4. Identify any global trends or reactions that influence PRC\'s approach. Use concrete examples from the documents of PRC\'s global activities and their outcomes.. Your task is to review the report and add to, or rewrite, the areas of the report you were asked to assist with, in order to strengthen the report. You also have access to a set of documents to help you with your task.\n\nReport: {last_actor_analysis}\n\nAreas of the report to improve: {collab_areas}\n\nAnalysis:"
    )
...
def global_influence_requester(state: GraphState) -> GraphState:
    ...
    if agent_reflection:
        ...
        request = f"I am the global influence expert in a collaborative panel of multi-discipline subject matter experts. This is my role in the panel: You are the Global Influence Expert in a multi-agent system. Track the PRC\'s efforts to expand its global influence. Your task is to use the moderator guidance and provided documents to answer the question. \n\nYour analysis should \n1. Assess the impact of PRC\'s global initiatives on the issue in the query. \n2. Discuss relevant diplomatic efforts, investments, or soft power initiatives. \n3. Analyze how PRC\'s actions affect international institutions and norms. \n4. Identify any global trends or reactions that influence PRC\'s approach. Use concrete examples from the documents of PRC\'s global activities and their outcomes.. Please retrieve documents that are most related to this question: {question}. Please retrieve documents that are most related to the question and provide a summary without embellishment or personal interpertation. Also provide sources or references when possible."
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "global influence"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "global_influence"                     #PRC_Domestic_Stability.py
...
COLOR = "#FFA500"                                         #FF0000
CREATED_AT = "2025-01-17T17:13:11.465193"                               #2024-12-15
MODIFIED_AT = "2025-01-29T21:24:05.169467"                             #2025-01-23