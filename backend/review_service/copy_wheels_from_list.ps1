...
# Get the directory where the script is located (review_service)
...
Write-Host "Starting copy process for review_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for review_service." -ForegroundColor Green
