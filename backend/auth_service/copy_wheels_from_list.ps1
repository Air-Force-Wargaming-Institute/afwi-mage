...
# Get the directory where the script is located (auth_service)
...
Write-Host "Starting copy process for auth_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for auth_service." -ForegroundColor Green
