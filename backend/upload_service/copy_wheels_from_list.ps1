...
# Get the directory where the script is located (upload_service)
...
Write-Host "Starting copy process for upload_service..." -ForegroundColor Yellow
...
Write-Host "Copy process finished for upload_service." -ForegroundColor Green
