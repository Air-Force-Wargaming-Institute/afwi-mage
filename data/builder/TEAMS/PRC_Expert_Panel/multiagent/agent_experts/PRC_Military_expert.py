...
def PRC_Military_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---PRC Military AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: PRC Military is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "PRC Military"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "PRC_Military"                     #PRC_Domestic_Stability.py
...
COLOR = "#FF0000"                                         #FF0000
CREATED_AT = "2025-02-03T21:51:40.182777"                               #2024-12-15
MODIFIED_AT = "2025-02-03T21:58:53.942963"                             #2025-01-23