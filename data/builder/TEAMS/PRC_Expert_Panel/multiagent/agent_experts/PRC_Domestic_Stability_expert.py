...
AGENT_NAME = "PRC Domestic Stability"
AGENT_FILE_NAME = "PRC_Domestic_Stability"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """PRC Domestic Stability Expert"""
...
MODIFIED_AT = "2025-02-07T20:21:16.196981"
...
def PRC_Domestic_Stability_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---PRC Domestic Stability AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
...
def PRC_Domestic_Stability_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---PRC Domestic Stability COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "PRC_Domestic_Stability"
    state_dict = state["keys"]
    question = state_dict["question"]
    ...
    prompt = PromptTemplate(
        ...
        template="You are the PRC Domestic Stability expert in a in a collaborative panel of multi-discipline subject matter experts. Here is your job description: You are the Domestic Stability expert in a multi-agent system.\n\nEvaluate internal social, demographic, and political factors in the PRC. \n\nYour task is to use the moderator guidance and provided documents to answer the question. \n\nYour analysis should \n1. Explain how domestic issues influence PRC\'s approach to the query topic. \n2. Discuss relevant public opinion trends, ethnic tensions, or domestic challenges.\n3. Analyze how internal stability concerns affect PRCs decision-making. \n4. Identify any recent domestic developments that impact the issue. Provide specific examples from the documents of domestic factors and their effects.. Your task is to review the report and add to, or rewrite, the areas of the report you were asked to assist with, in order to strengthen the report. You also have access to a set of documents to help you with your task.\n\nReport: {last_actor_analysis}\n\nAreas of the report to improve: {collab_areas}\n\nAnalysis:"
    )
...
def PRC_Domestic_Stability_requester(state: GraphState) -> GraphState:
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "PRC Domestic Stability"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "PRC_Domestic_Stability"                     #PRC_Domestic_Stability.py
...
MODIFIED_AT = "2025-02-07T20:21:16.196981"                             #2025-01-23