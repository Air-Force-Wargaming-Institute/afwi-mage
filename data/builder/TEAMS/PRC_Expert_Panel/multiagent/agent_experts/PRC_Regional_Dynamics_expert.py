...
def PRC_Regional_Dynamics_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---PRC Regional Dynamics AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: PRC Regional Dynamics is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def PRC_Regional_Dynamics_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---PRC Regional Dynamics COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "PRC_Regional_Dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def PRC_Regional_Dynamics_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---PRC Regional Dynamics REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "PRC_Regional_Dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "PRC Regional Dynamics"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "PRC_Regional_Dynamics"                     #PRC_Domestic_Stability.py
...
COLOR = "#FF0000"                                         #FF0000
CREATED_AT = "2025-02-03T21:52:07.796371"                               #2024-12-15
MODIFIED_AT = "2025-02-03T21:59:03.218543"                             #2025-01-23