...
def US_Regional_Dynamics_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---US Regional Dynamics AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: US Regional Dynamics is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def US_Regional_Dynamics_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Regional Dynamics COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Regional_Dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def US_Regional_Dynamics_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Regional Dynamics REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Regional_Dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "US Regional Dynamics"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "US_Regional_Dynamics"                     #PRC_Domestic_Stability.py
...
MODIFIED_AT = "2025-02-04T15:40:43.306888"                             #2025-01-23