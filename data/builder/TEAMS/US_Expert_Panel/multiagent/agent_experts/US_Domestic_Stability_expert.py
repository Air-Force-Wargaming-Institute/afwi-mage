...
AGENT_NAME = "US Domestic Stability"
AGENT_FILE_NAME = "US_Domestic_Stability"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """US Domestic Stability Expert"""
...
MODIFIED_AT = "2025-02-06T17:12:15.402630"
...
def US_Domestic_Stability_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---US Domestic Stability AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        # print("\tINFO: US Domestic Stability is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def US_Domestic_Stability_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Domestic Stability COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Domestic_Stability"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def US_Domestic_Stability_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Domestic Stability REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Domestic_Stability"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "US Domestic Stability"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "US_Domestic_Stability"                     #PRC_Domestic_Stability.py
...
MODIFIED_AT = "2025-02-06T17:12:15.402630"                             #2025-01-23