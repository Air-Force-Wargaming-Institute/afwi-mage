...
def US_Government_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---US Government AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        # print("\tINFO: US Government is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def US_Government_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Government COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Government"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def US_Government_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---US Government REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "US_Government"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "US Government"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "US_Government"                     #PRC_Domestic_Stability.py
...
COLOR = "#0000FF"                                         #FF0000
CREATED_AT = "2025-02-04T15:37:27.940271"                               #2024-12-15
MODIFIED_AT = "2025-02-07T20:21:43.059036"                             #2025-01-23