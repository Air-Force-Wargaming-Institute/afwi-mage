...
AGENT_NAME = "domestic stability"
AGENT_FILE_NAME = "domestic_stability"
...
COLOR = "#FFA500"
CREATED_AT = "2025-01-17T17:02:02.982439"
MODIFIED_AT = "2025-01-29T23:10:53.931478"
...
def domestic_stability_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---domestic stability AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: domestic stability is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "domestic stability"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "domestic_stability"                     #PRC_Domestic_Stability.py
...
COLOR = "#FFA500"                                         #FF0000
CREATED_AT = "2025-01-17T17:02:02.982439"                               #2024-12-15
MODIFIED_AT = "2025-01-29T23:10:53.931478"                             #2025-01-23