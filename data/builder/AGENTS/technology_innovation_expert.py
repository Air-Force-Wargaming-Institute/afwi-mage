...
AGENT_NAME = "technology innovation"
AGENT_FILE_NAME = "technology_innovation"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """PRC Technology Innovation Expert"""
...
COLOR = "#FFA500"
CREATED_AT = "2025-01-17T17:16:29.568255"
MODIFIED_AT = "2025-01-29T23:13:39.903150"
...
def technology_innovation_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---technology innovation AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: technology innovation is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def technology_innovation_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---technology innovation REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "technology_innovation"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "technology innovation"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "technology_innovation"                     #PRC_Domestic_Stability.py
...
COLOR = "#FFA500"                                         #FF0000
CREATED_AT = "2025-01-17T17:16:29.568255"                               #2024-12-15
MODIFIED_AT = "2025-01-29T23:13:39.903150"                             #2025-01-23