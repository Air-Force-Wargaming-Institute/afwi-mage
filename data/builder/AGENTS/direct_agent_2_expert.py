...
AGENT_NAME = "direct_agent_2"
AGENT_FILE_NAME = "direct_agent_2"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """Second AI assistant that does your best to help answer any question or query that the user has."""
AGENT_INSTRUCTIONS = """You are another AI assistant that does your best to help answer any question or query that the user has."""
LLM_MODEL = "gpt-3.5-turbo"
COLOR = "#32CD32"
CREATED_AT = "2025-01-29T19:37:23.593986"
MODIFIED_AT = "2025-01-29T23:10:51.378448"
...
def direct_agent_2_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---direct_agent_2 AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: direct_agent_2 is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def direct_agent_2_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---direct_agent_2 COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "direct_agent_2"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def direct_agent_2_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---direct_agent_2 REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "direct_agent_2"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "direct_agent_2"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "direct_agent_2"                     #PRC_Domestic_Stability.py
...
COLOR = "#32CD32"                                         #FF0000
CREATED_AT = "2025-01-29T19:37:23.593986"                               #2024-12-15
MODIFIED_AT = "2025-01-29T23:10:51.378448"                             #2025-01-23