...
AGENT_NAME = "regional dynamics"
AGENT_FILE_NAME = "regional_dynamics"
...
COLOR = "#FFA500"
CREATED_AT = "2025-01-17T17:15:51.551705"
MODIFIED_AT = "2025-01-29T23:13:36.960638"
...
def regional_dynamics_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---regional dynamics AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: regional dynamics is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
def regional_dynamics_collaborator(state: GraphState, llm: ChatOpenAI) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---regional dynamics COLLABORATOR---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "regional_dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
def regional_dynamics_requester(state: GraphState) -> GraphState:
    banner = "\n\n\t---------------------------\n\n\t---regional dynamics REQUESTER---\n\n\t---------------------------\n\n\t"
    print(banner.upper())
    whoami = "regional_dynamics"
    state_dict = state["keys"]
    question = state_dict["question"]
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "regional dynamics"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "regional_dynamics"                     #PRC_Domestic_Stability.py
...
COLOR = "#FFA500"                                         #FF0000
CREATED_AT = "2025-01-17T17:15:51.551705"                               #2024-12-15
MODIFIED_AT = "2025-01-29T23:13:36.960638"                             #2025-01-23