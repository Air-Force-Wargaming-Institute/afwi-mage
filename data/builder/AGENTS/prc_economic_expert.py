...
AGENT_NAME = "prc economic"
AGENT_FILE_NAME = "prc_economic"
MEMORY_TYPE = "ConversationBufferMemory"
MEMORY_KWARGS = {"max_token_limit": 2000}
AGENT_DESCRIPTION = """PRC Economic Expert"""
...
COLOR = "#FFA500"
CREATED_AT = "2025-01-17T17:14:19.723727"
MODIFIED_AT = "2025-01-29T23:11:01.740877"
...
def prc_economic_expert(state: GraphState, llm: ChatOpenAI) -> GraphState:
    ...
    if reflected:
        banner = "\n\n\t---------------------------\n\n\t---prc economic AFTER REFLECTION & COLLABORATION---\n\n\t---------------------------\n\n\t"
        print(banner.upper())
        ...
        print("\tINFO: prc economic is using this list of experts while choosing collaborators: \n\t"+expert_agents_str)
...
# The following will be filled in programmatically when creating a new agent
AGENT_NAME = "prc economic"                               #PRC_Domestic_Stability
AGENT_FILE_NAME = "prc_economic"                     #PRC_Domestic_Stability.py
...
COLOR = "#FFA500"                                         #FF0000
CREATED_AT = "2025-01-17T17:14:19.723727"                               #2024-12-15
MODIFIED_AT = "2025-01-29T23:11:01.740877"                             #2025-01-23