...
export const AnimatedContentArea = styled(Box)(({ theme }) => ({
  ...
  backgroundColor: 'transparent',
  color: theme.palette.text.primary,
  border: `${theme.custom.borderWidth.thin}px solid transparent`,
  borderRadius: theme.shape.borderRadius,
  boxSizing: 'border-box',
  overflow: 'hidden',
  flex: 1,
  ...
  '&::after': {
    content: '""',
    position: 'absolute',
    top: theme.custom.borderWidth.thin,
    left: theme.custom.borderWidth.thin,
    right: theme.custom.borderWidth.thin,
    bottom: theme.custom.borderWidth.thin,
    borderRadius: theme.shape.borderRadius - theme.custom.borderWidth.thin/2,
    background: theme.palette.background.paper,
    zIndex: -1,
  },
  '& > *': {
