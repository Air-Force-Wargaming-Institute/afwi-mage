...
import LLMLibrary from './LLMLibrary';
...
import WargamesListPage from '../wargame_builder/WargamesListPage';
    ...
    <div className="root-container">
      ...
      <Paper className="main-content">
        <Switch>
          ...
          <Route exact path="/multi-agent/team-chat/wargame_builder" component={WargamesListPage} />
