...
const useStyles = makeStyles((theme) => ({
  ...
  tabPanel: {
    ...
    height: '60vh',
    overflowY: 'auto', // Keep only this scroll
    flex: 1,
  },
  sectionTitle: {
...
function NationPostureModal({ open, onClose, nation, otherNations, onSave, nationRelationships = {} }) {
  ...
  // Initialize nation data when modal opens
  useEffect(() => {
    if (nation) {
  ...
  const handleRemoveRelationship = (entityId) => {
    const updatedRelationships = { ...nationData.relationships };
    delete updatedRelationships[entityId];
  ...
  // If no nation is provided, don't render the modal
  ...
  return (
    ...
    >
      ...
      >
        <Tab 
          label={<Typography variant="h4" style={{ fontSize: '2rem', fontWeight: 700 }}>Relationships</Typography>} 
          id="dime-tab-0"
          aria-controls="dime-tabpanel-0"
        />
        <Tab 
          label={<Typography variant="h4" style={{ fontSize: '2rem', fontWeight: 700 }}>Diplomacy</Typography>} 
          id="dime-tab-1"
          aria-controls="dime-tabpanel-1" 
        />
        <Tab 
          label={<Typography variant="h4" style={{ fontSize: '2rem', fontWeight: 700 }}>Information</Typography>} 
          id="dime-tab-2"
          aria-controls="dime-tabpanel-2"
        />
        <Tab 
          label={<Typography variant="h4" style={{ fontSize: '2rem', fontWeight: 700 }}>Military</Typography>} 
          id="dime-tab-3"
          aria-controls="dime-tabpanel-3"
        />
        <Tab 
          label={<Typography variant="h4" style={{ fontSize: '2rem', fontWeight: 700 }}>Economic</Typography>} 
          id="dime-tab-4"
...
export default NationPostureModal; 